...
--
-- NOTE: This behaves differently than `NriPrelude.Internal.map2`, which produces
-- all combinations of elements from both lists.
map2 :: (a -> b -> result) -> List a -> List b -> List result
map2 =
  Data.List.zipWith

-- | NOTE: This behaves differently than `NriPrelude.Internal.map3`, which produces
-- all combinations of elements from all lists.
map3 :: (a -> b -> c -> result) -> List a -> List b -> List c -> List result
map3 =
  Data.List.zipWith3

-- | NOTE: This behaves differently than `NriPrelude.Internal.map4`, which produces
-- all combinations of elements from all lists.
map4 :: (a -> b -> c -> d -> result) -> List a -> List b -> List c -> List d -> List result
map4 =
  Data.List.zipWith4

-- | NOTE: This behaves differently than `NriPrelude.Internal.map5`, which produces
-- all combinations of elements from all lists.
