...
- Support GHC 9.10.2, GHC 9.12.2, `network-3.3.x.x`, `filepath-1.5.x`, `template-haskell-2.22.x.x`

# 0.3.0.0

- Drop support for GHC 9.2.x
- Support GHC 9.8.3, `bytestring-0.12.x.x`, `text-2.1.x`, `template-haskell-2.21.x.x`
